...
export default {
  ...
  fonts: {
    ...
    monospace: "'Fira Sans', sans-serif"
  },
  shadows: {
    ...theme.shadows,
    faint: '0px 2px 7px #EAEFF440',
    cardShadow: '0 5px 20px 0 rgba(138, 155, 165, 0.1)'
  },
      ...
      path: (
        <g>
          <path
            ...
            fill="#2794e9"
          />
          <circle cx="30" cy="30" r="25" fill="#2794e9"/>
          <path
    ...
    burnSuccess: {
      path: (
        <g fill="none">
          ...
          <circle cx="59.5" cy="59.5" r="58" stroke="#2794e9" strokeWidth="3"/>
          <path
